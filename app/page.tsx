...
import { DHBWLogo, StreamifyLogo } from "@/components/logos";
      ...
      <div className="min-h-[100vh] sm:min-h-screen w-screen flex flex-col relative bg-[#F2F3F5] font-inter overflow-hidden">
        ...
        <main className="flex flex-col justify-center h-[90%] static md:fixed w-screen overflow-hidden grid-rows-[1fr_repeat(3,auto)_1fr] z-[100] pt-[30px] pb-[320px] px-4 md:px-20 md:py-0">
          ...
          <motion.h1
            ...
            className="relative md:ml-[-10px] md:mb-[37px] font-extrabold text-[16vw] md:text-[110px] font-inter text-[#1E2B3A] leading-[0.9] tracking-[-2px] z-[100]"
          >
            Ihr Katalysator <br />
          ...
          >
            <div className="w-full">
              <p className="text-lg leading-relaxed text-[#1a2b3b] font-normal">
                ...
                mit Databrix &minus; <br />
                der Plattform, die Lernen, Anwenden und Zusammenarbeiten nahtlos
                integriert.
              </p>
            </div>
            {/* <div className="w-1/2">
          ...
          <div className="flex gap-[15px] mt-8 md:mt-0">
            ...
            >
              ...
              >
                <span className="w-5 h-5 rounded-full text-white flex items-center justify-center">
                  <GithubIcon />
                </span>
                Star on Github
              </Link>
        ...
        <div className="h-[60px] bg-[#1D2B3A] fixed bottom-0 z-20 w-full flex flex-row items-center justify-start gap-8 px-16">
          ...
          <StreamifyLogo className="h-8 opacity-80 text-white" />
        </div>
      </div>
    </AnimatePresence>
  );
